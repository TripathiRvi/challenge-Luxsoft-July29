...
public class AccountsControllerTest {
  ...
  public void createAccount() throws Exception {
    createAccountWithContent("{\"accountId\":\"Id000-ravi-1\",\"balance\":50000}").andExpect(status().isCreated());

    Account account = accountsService.getAccount("Id000-ravi-1");
    assertThat(account.getAccountId()).isEqualTo("Id000-ravi-1");
  ...
  public void createDuplicateAccount() throws Exception {
    ...
    createAccountWithContent("{\"accountId\":\"Id000-ravi-1\",\"balance\":50000}").andExpect(status().isBadRequest());
  }

  @Test
  public void createAccountNoAccountId() throws Exception {
    createAccountWithContent("{\"balance\":50000}")
